...
class ClientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cliente" do
    assert_difference('Cliente.count') do
      post clientes_url, params: { cliente: { nombre_cliente: @cliente.nombre_cliente, rfc: @cliente.rfc } }
    end
  ...
  test "should update cliente" do
    patch cliente_url(@cliente), params: { cliente: { nombre_cliente: @cliente.nombre_cliente, rfc: @cliente.rfc } }
